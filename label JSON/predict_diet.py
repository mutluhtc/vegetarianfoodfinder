...
INPUT_JSON_FILE = "./structured_JSON_data_files/boston_restaurants_with_structured_menus.json"
OUTPUT_JSON_FILE = "./final_JSON/boston_restaurants_with_vegetarian_labels.json"
